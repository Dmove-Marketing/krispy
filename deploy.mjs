...
execSync(
  `ssh -o StrictHostKeyChecking=no ${user}@${server} "find ${remote_path} -type d -exec chmod 755 {} \\; && find ${remote_path} -type f -exec chmod 644 {} \\;"`,
  { stdio: "inherit" }
);
console.log("Permissões ajustadas.");
